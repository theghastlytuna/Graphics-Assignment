...
void Application::_Run()
{
	...
	while (_isRunning) {
		...
		{
			if (GetLayer<RenderLayer>()->GetRenderFlags() == RenderFlags::EnableNoLight)
			{
				GetLayer<RenderLayer>()->SetRenderFlags(RenderFlags::None);
			}
			else
			{
				GetLayer<RenderLayer>()->SetRenderFlags(RenderFlags::EnableNoLight);
			}
		}
		...
		{
			if (GetLayer<RenderLayer>()->GetRenderFlags() == RenderFlags::EnableAmbientSpecular)
			{
				GetLayer<RenderLayer>()->SetRenderFlags(RenderFlags::None);
			}
			else
		...
		{
			if (GetLayer<RenderLayer>()->GetRenderFlags() == RenderFlags::EnableAmbientSpecularCustom)
			{
				GetLayer<RenderLayer>()->SetRenderFlags(RenderFlags::None);
			}
			else
			{
				GetLayer<RenderLayer>()->SetRenderFlags(RenderFlags::EnableAmbientSpecularCustom);
			}
		}
		else if (InputEngine::GetKeyState(GLFW_KEY_6) == ButtonState::Pressed)
		{
			if (GetLayer<RenderLayer>()->GetRenderFlags() == RenderFlags::EnableDiffuseRamp)
			{
				GetLayer<RenderLayer>()->SetRenderFlags(RenderFlags::None);
			}
			else
		...
		{
			if (GetLayer<RenderLayer>()->GetRenderFlags() == RenderFlags::EnableSpecularRamp)
			{
				GetLayer<RenderLayer>()->SetRenderFlags(RenderFlags::None);
			}
			else
		...
		{
			if (GetLayer<RenderLayer>()->GetRenderFlags() == RenderFlags::EnableWarmCorrection)
			{
				GetLayer<RenderLayer>()->SetRenderFlags(RenderFlags::None);
			}
			else
		...
		{
			if (GetLayer<RenderLayer>()->GetRenderFlags() == RenderFlags::EnableCoolCorrection)
			{
				GetLayer<RenderLayer>()->SetRenderFlags(RenderFlags::None);
			}
			else
			{
				GetLayer<RenderLayer>()->SetRenderFlags(RenderFlags::EnableCoolCorrection);
			}
		}
		else if (InputEngine::GetKeyState(GLFW_KEY_0) == ButtonState::Pressed)
		{
			if (GetLayer<RenderLayer>()->GetRenderFlags() == RenderFlags::EnableInvertCorrection)
			{
				GetLayer<RenderLayer>()->SetRenderFlags(RenderFlags::None);
			}
			else
			{
				GetLayer<RenderLayer>()->SetRenderFlags(RenderFlags::EnableInvertCorrection);
			}
		}
