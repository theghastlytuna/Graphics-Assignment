...
void DefaultSceneLayer::_CreateScene()
{
	...
	if (loadScene && std::filesystem::exists("scene.json")) {
		...
		Texture3D::Sptr lut = ResourceManager::CreateAsset<Texture3D>("luts/Warmer.CUBE");  
		Texture3D::Sptr lut2 = ResourceManager::CreateAsset<Texture3D>("luts/cool.cube");
		Texture3D::Sptr lut3 = ResourceManager::CreateAsset<Texture3D>("luts/invert.CUBE");
		...
		Material::Sptr boxMaterial = ResourceManager::CreateAsset<Material>(basicShader);
		{
			...
			boxMaterial->Set("u_Material.oneDLut", toonLut);
		}
		...
		Material::Sptr monkeyMaterial = ResourceManager::CreateAsset<Material>(basicShader);
		{
			...
			monkeyMaterial->Set("u_Material.oneDLut", toonLut);
		...
		Material::Sptr foliageMaterial = ResourceManager::CreateAsset<Material>(foliageShader);
		{
			...
			foliageMaterial->Set("u_Material.oneDLut", toonLut);
		...
		Material::Sptr toonMaterial = ResourceManager::CreateAsset<Material>(toonShader);
		{
			...
			toonMaterial->Set("u_Material.Diffuse", monkeyTex);
		...
		sphere->AddParam(MeshBuilderParam::CreateIcoSphere(ZERO, glm::vec3(2.f), 5));
		sphere->GenerateMesh();
		...
		{
			camera->SetPostion({ -5, 0, 4 });
			camera->SetRotation({ 90.f, 0.f, -90.f });
		...
		GameObject::Sptr monkey1 = scene->CreateGameObject("Monkey 1");
		{
			...
			monkey1->SetPostion(glm::vec3(0.f, 0.0f, 1.0f));

			// Add some behaviour that relies on the physics body
			monkey1->Add<RotatingBehaviour>()->RotationSpeed = glm::vec3(0.f, 0.f, 25.f);
		...
		{
			// Set position in the scene
			monkey2->SetPostion(glm::vec3(1.5f, 2.0f, 1.0f));

			// Add some behaviour that relies on the physics body
			monkey2->Add<RotatingBehaviour>()->RotationSpeed = glm::vec3(0.f, 0.f, 25.f);
		...
		GameObject::Sptr monkey3 = scene->CreateGameObject("Monkey 1");
		{
			// Set position in the scene
			monkey3->SetPostion(glm::vec3(1.5f, -2.0f, 1.0f));

			// Add some behaviour that relies on the physics body
			monkey3->Add<RotatingBehaviour>()->RotationSpeed = glm::vec3(0.f, 0.f, 25.f);
		...
		GameObject::Sptr foliageBall1 = scene->CreateGameObject("Foliage Sphere 1");
		{
			// Set and rotation position in the scene
			foliageBall1->SetPostion(glm::vec3(4.0f, -4.0f, 7.0f));

			// Add a render component
			RenderComponent::Sptr renderer = foliageBall1->Add<RenderComponent>();
			renderer->SetMesh(sphere);
			renderer->SetMaterial(foliageMaterial);
		}

		GameObject::Sptr trunk1 = scene->CreateGameObject("Tree 1");
		{
			// Set and rotation position in the scene
			trunk1->SetPostion(glm::vec3(4, -4.0f, 1.0f));

			// Add a render component
			RenderComponent::Sptr renderer = trunk1->Add<RenderComponent>();
			renderer->SetMesh(boxMesh);
			renderer->SetMaterial(boxMaterial);
		}
		GameObject::Sptr trunk2 = scene->CreateGameObject("Tree 2");
		{
			// Set and rotation position in the scene
			trunk2->SetPostion(glm::vec3(4, -4.0f, 2.0f));

			// Add a render component
			RenderComponent::Sptr renderer = trunk2->Add<RenderComponent>();
			renderer->SetMesh(boxMesh);
			renderer->SetMaterial(boxMaterial);
		}
		GameObject::Sptr trunk3 = scene->CreateGameObject("Tree 3");
		{
			// Set and rotation position in the scene
			trunk3->SetPostion(glm::vec3(4, -4.0f, 3.0f));

			// Add a render component
			RenderComponent::Sptr renderer = trunk3->Add<RenderComponent>();
			renderer->SetMesh(boxMesh);
			renderer->SetMaterial(boxMaterial);
		}
		GameObject::Sptr trunk4 = scene->CreateGameObject("Tree 4");
		{
			// Set and rotation position in the scene
			trunk4->SetPostion(glm::vec3(4, -4.0f, 4.0f));

			// Add a render component
			RenderComponent::Sptr renderer = trunk4->Add<RenderComponent>();
			renderer->SetMesh(boxMesh);
			renderer->SetMaterial(boxMaterial);
		}
		GameObject::Sptr trunk5 = scene->CreateGameObject("Tree 5");
		{
			// Set and rotation position in the scene
			trunk5->SetPostion(glm::vec3(4, -4.0f, 5.0f));

			// Add a render component
			RenderComponent::Sptr renderer = trunk5->Add<RenderComponent>();
			renderer->SetMesh(boxMesh);
			renderer->SetMaterial(boxMaterial);
		}
		GameObject::Sptr trunk6 = scene->CreateGameObject("Tree 6");
		{
			// Set and rotation position in the scene
			trunk6->SetPostion(glm::vec3(4, -4.0f, 6.0f));

			// Add a render component
			RenderComponent::Sptr renderer = trunk6->Add<RenderComponent>();
			renderer->SetMesh(boxMesh);
			renderer->SetMaterial(boxMaterial);
		}
		...
		{
			// Set and rotation position in the scene
			foliageBall2->SetPostion(glm::vec3(4.0f, 4.0f, 7.0f));
		...
		GameObject::Sptr trunk7 = scene->CreateGameObject("Tree 1");
		{
			// Set and rotation position in the scene
			trunk7->SetPostion(glm::vec3(4, 4.0f, 1.0f));

			// Add a render component
			RenderComponent::Sptr renderer = trunk7->Add<RenderComponent>();
			renderer->SetMesh(boxMesh);
			renderer->SetMaterial(boxMaterial);
		}
		GameObject::Sptr trunk8 = scene->CreateGameObject("Tree 1");
		{
			// Set and rotation position in the scene
			trunk8->SetPostion(glm::vec3(4, 4.0f, 2.0f));

			// Add a render component
			RenderComponent::Sptr renderer = trunk8->Add<RenderComponent>();
			renderer->SetMesh(boxMesh);
			renderer->SetMaterial(boxMaterial);
		}
		GameObject::Sptr trunk9 = scene->CreateGameObject("Tree 1");
		{
			// Set and rotation position in the scene
			trunk9->SetPostion(glm::vec3(4, 4.0f, 3.0f));

			// Add a render component
			RenderComponent::Sptr renderer = trunk9->Add<RenderComponent>();
			renderer->SetMesh(boxMesh);
			renderer->SetMaterial(boxMaterial);
		}
		GameObject::Sptr trunk10 = scene->CreateGameObject("Tree 1");
		{
			// Set and rotation position in the scene
			trunk10->SetPostion(glm::vec3(4, 4.0f, 4.0f));

			// Add a render component
			RenderComponent::Sptr renderer = trunk10->Add<RenderComponent>();
			renderer->SetMesh(boxMesh);
			renderer->SetMaterial(boxMaterial);
		}
		GameObject::Sptr trunk11 = scene->CreateGameObject("Tree 1");
		{
			// Set and rotation position in the scene
			trunk11->SetPostion(glm::vec3(4, 4.0f, 5.0f));

			// Add a render component
			RenderComponent::Sptr renderer = trunk11->Add<RenderComponent>();
			renderer->SetMesh(boxMesh);
			renderer->SetMaterial(boxMaterial);
		}
		GameObject::Sptr trunk12 = scene->CreateGameObject("Tree 1");
		{
			// Set and rotation position in the scene
			trunk12->SetPostion(glm::vec3(4, 4.0f, 6.0f));

			// Add a render component
			RenderComponent::Sptr renderer = trunk12->Add<RenderComponent>();
			renderer->SetMesh(boxMesh);
			renderer->SetMaterial(boxMaterial);
		}
